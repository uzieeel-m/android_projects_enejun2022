...
public class ListaSencillaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lstvEstados.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override               //padre del list view, elemento que se seleccionó, indice selecc, ?
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                txtvResultado.setText("La capital del estado de " + estados[i] + " es "+capitales[i]);
                //otra forma de obtener el estado seleccionado
                String estado = ((TextView)view).getText().toString();
                Toast.makeText(getApplicationContext(), "Seleccionó: "+estado, Toast.LENGTH_SHORT).show();
