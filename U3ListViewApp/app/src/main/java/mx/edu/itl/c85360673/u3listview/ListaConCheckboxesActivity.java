...
public class ListaConCheckboxesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter adaptador = new ArrayAdapter(this, android.R.layout.simple_list_item_multiple_choice, animales);
    ...
    public void btnElementosSeleccionadosClick ( View v ) {
        ...
        SparseBooleanArray elementosMarcados =
                lstvAnimales.getCheckedItemPositions ();
        ...
        Toast.makeText(this, "Elementos seleccionados: "+seleccionados.toString(), Toast.LENGTH_SHORT).show();
    }
